...
RUN bash -c "$(curl -fsSL https://fnm.vercel.app/install)"
...
RUN curl -fsSL -o /root/simple.omp.yaml https://raw.githubusercontent.com/f3lin/my-terminal/main/themes/dev-remote.yaml
...
# Init script to install the correct font and check insalled freameworks versions
RUN bash -c "$(curl -fsSL https://raw.githubusercontent.com/f3lin/qcm-api/main/init.sh)"
